...
let styleSources = [
  "'self'",
  "'unsafe-inline'", // Needed for Next.js styles
  "https://fonts.googleapis.com",
  "https://cdnjs.cloudflare.com",
  "https://stackpath.bootstrapcdn.com",
  "https://css.zohocdn.com",
...
if (isDev) {
  // Development: allow eval/inline and local connections
  scriptSources.push("'unsafe-eval'");
  scriptSources.push("'unsafe-inline'");
  connectSources.push("http:");
  connectSources.push("ws:");
  ...
  // Production: optional inline script hash (update if inline scripts change)
  scriptSources.push("'sha256-7Ayf/i8gH+ASideztFT+YbgRd62nZdTXp4RbP3P4hjk='");
}
...
const securityHeaders = [
  ...
  { key: "X-Frame-Options", value: "DENY" }, // Fixes Clickjacking warning
  { key: "X-Content-Type-Options", value: "nosniff" },
  { key: "Referrer-Policy", value: "strict-origin-when-cross-origin" },
  { key: "X-XSS-Protection", value: "1; mode=block" },
  { key: "X-Powered-By", value: "" },
  ...
  // These fix newer browser isolation and cross-origin issues safely
  { key: "Cross-Origin-Embedder-Policy", value: "unsafe-none" },
  { key: "Cross-Origin-Opener-Policy", value: "same-origin-allow-popups" },
];
